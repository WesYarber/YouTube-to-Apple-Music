...
If you are on Mac, you should be able to run the YT2AM-MacOS executable. On Mac or Windows, you can install the required python libraries and run it as a python script:
